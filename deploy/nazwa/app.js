/**
 * CommonJS entry for nazwa.pl CloudHosting Panel (Node interpreter).
 * Upload this file + `dist/` into the app directory (no package.json with "type":"module").
 * Enable/disable by switching the domain interpreter to Node.js / PHP in the panel.
 */
